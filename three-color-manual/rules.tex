...
%% The colors are not all of
%% equal difficulty.  Combined with the different scoring options, this
%% allows for a range of interesting handicaps for coping with a wide
